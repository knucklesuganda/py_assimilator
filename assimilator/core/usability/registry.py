...
from assimilator.core.usability.exceptions import (
...
def get_pattern(
    provider: str, pattern_name: str
) -> Type[Union[Repository, UnitOfWork, CRUDService]]:
    try:
    ...
    if pattern_cls is None:
        raise PatternNotFoundError(
            f"Pattern '{pattern_name}' for {provider} provider was not found"
        )
