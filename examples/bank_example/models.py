...
class User(Base):
    ...
    transactions_out: Mapped[list["UserTransaction"]] = relationship(
        ...
        foreign_keys="UserTransaction.sender_id",
    )
    transactions_in: Mapped[list["UserTransaction"]] = relationship(
        "UserTransaction",
        back_populates="receiver",
        foreign_keys="UserTransaction.receiver_id",
    )
...
class UserTransaction(Base):
    ...
    sender: Mapped[User] = relationship(
        "User", foreign_keys=[sender_id], back_populates="transactions_out"
    )
    ...
    receiver: Mapped[User] = relationship(
        "User", foreign_keys=[receiver_id], back_populates="transactions_in"
    )
