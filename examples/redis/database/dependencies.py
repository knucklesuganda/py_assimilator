...
# session = Redis()
# session = {}
from mongo.database import MongoUnitOfWork, MongoRepository, MongoModel
...
def create_repository():    # factory for RedisRepository
    ...
    return MongoRepository(session, model=User, database='test')
...
def create_uow():  # factory for RedisUnitOfWork
    ...
    return MongoUnitOfWork(repository=create_repository())
